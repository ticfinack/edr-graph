"""Tests for _trigger_response and _graph_chain_to_chainsteps."""
...
from agent.main import _graph_chain_to_chainsteps, _trigger_response
...
class TestGraphChainToChainsteps:
    def test_chainsteps_user_entry(self):
        ...
        steps = _graph_chain_to_chainsteps(graph_chain)
        assert len(steps) == 1
